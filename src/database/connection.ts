...
import { URL } from 'url';
import { DatabaseConfig, DatabaseConnectionOptions, QueryResult } from './types.js';
...
export class DatabaseConnection {
  ...
  static async createConnection(options: DatabaseConnectionOptions): Promise<mysql.Connection> {
    try {
  ...
  static async executeQuery(connection: mysql.Connection, query: string, params?: any[]): Promise<QueryResult> {
    try {
  ...
  static async closeConnection(connection: mysql.Connection): Promise<void> {
    try {
